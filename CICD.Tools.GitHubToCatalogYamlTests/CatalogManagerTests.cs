...
namespace Skyline.DataMiner.CICD.Tests
{
	[TestClass]
	public class CatalogManagerTests
	{
		...
		private string workspace = "testWorkspace";
		private string catalogFilePath = "testWorkspace/catalog.yml";
		private string manifestFilePath = "testWorkspace/manifest.yml";
