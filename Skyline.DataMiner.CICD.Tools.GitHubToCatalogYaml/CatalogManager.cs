namespace Skyline.DataMiner.CICD.Tools.GitHubToCatalogYaml
{
    ...
    internal class CatalogManager
    {
        ...
        /// <param name="allowNewCatalogGuid">Indicates whether a new catalog GUID may be generated when no ID is available.</param>
        ...
        public async Task ProcessCatalogYamlAsync(string repoName, string catalogIdentifier = "", bool allowNewCatalogGuid = true)
        {
            ...
            CheckId(catalogYaml, autoGeneratedCatalogYaml, catalogIdentifier, allowNewCatalogGuid);
        ...
        /// <param name="allowNewCatalogGuid">Indicates whether a new catalog GUID may be generated when no ID is available.</param>
        private void CheckId(CatalogYaml catalogYaml, CatalogYaml autoGeneratedCatalogYaml, string catalogIdentifier, bool allowNewCatalogGuid)
        {
